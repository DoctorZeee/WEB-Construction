            ...
            <main>
                ...
                <section className="section-9 py-5">
                    <div className="container">
                        ...
                        <h2>Contact Us</h2>
                        <p>
                            Our dedicated experts are here to help you with any
                            of your questions, contact us by <br />
                            filling out the form below and we will be in touch
                            shortly.
                        </p>
                    </div>
                        ...
                        <div className="col-md-3">
                            <div className="card shadow border-0 mb-3">
                                <div className="card-body p-4">
                                    <h3>Call Us</h3>
                                    <div><a href="#">(0812-3456-7890)</a></div>
                                    ...
                                    <div>
                                        B35 Perum Mentari Jaya Sumbang, <br />
                                        Banyumas, 56789
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="card shadow border-0">
                                <div className="card-body p-5">
                                    ...
                                    <div>
                                        ...
                                        <textarea name="" rows={5} id="" className="form-control form-control-lg" placeholder="Message"></textarea>
                                    </div>
